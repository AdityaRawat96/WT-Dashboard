                                            ...
                                            <div role="tabpanel" class="tab-pane" id="settings11">
                                                <div class="widget p-25">
                                                    <div class="widget-body">
                                                        <a onclick="myFunction();" style="cursor:pointer;">Change Password</a><br><br>
                                                        <input type="password" name="currentpwd" id='cpwd' placeholder="Current Password" style="visibility:hidden"><br><br>
                                                        <input type="password" name="newpwd" id='npwd' placeholder="New Password"  style="visibility:hidden"><br><br>
                                                        <input type="password" name="newpwd1" id='npwd1' placeholder="Re-Enter New Password"  style="visibility:hidden"><br><br>
                                                        <button type="button" class="btn btn-success" id="sbmt"  style="visibility:hidden" onclick="mySubmit();">Submit</button>
                                                        <input type="text" id="taketext" value="<?php echo $password; ?>" hidden>
