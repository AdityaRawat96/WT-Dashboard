                          ...
                          <div class="card" style="">
                              <form method="get" class="form-horizontal">
                                  <div class="card-header card-header-text">
                                      <h4 class="card-title">Report By Department</h4>
                                  </div>
                                  <div class="card-content">
                                    <table style="margin-left:15%;">
                                      ...
                                      <tr>
                                      <td><label for="category">SELECT DEPARTMENT:</label></td>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                                      <td>
                                        <select class="selectpicker" data-style="btn btn-info btn-round" title="Single Select" data-size="7" id="category" name="category">
