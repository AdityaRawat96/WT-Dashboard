...
if(isset($_SESSION['Username'])&&$_SESSION['Rights']=='admin')
{
  ...
  <body class="w3-theme-l3" onload="$('.loader').fadeOut();">
  ...
  function sendNotification(b){
    $.ajax({
      ...
      data: {  category: "leave", name: "Your", description: "leave request is"+leaveStatus, target: b, link: "../dashboard/employee_dashboard.php" },
