                            ...
                            <form method="#" action="#">
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-wd btn-lg btn-success"  onclick="check();">Submit</button>
                                         <button type="submit" class="btn btn-wd btn-lg btn-success" onclick="skip();">Skip</button><br>
                                    </div>
                                </div>
                            </form>
                        </div>
